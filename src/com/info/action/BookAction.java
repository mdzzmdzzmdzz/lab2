...
public class BookAction implements Action {
	...
	public String Query() throws Exception {
		try
		{
			...
			connect=DriverManager.getConnection("jdbc:mysql://ihtbhdacylko.rds.sae.sina.com.cn:10198/guoxin?useUnicode=true&characterEncoding=utf-8&useSSL=false","guoxin","wan2013");
	...
	public String InsertAuthor() throws Exception{
		...
		if(!res.next()){
			...
			String sql1 = "update Book set AuthorID='"+getAuthorID()+"' where Title='"+getTitle()+"'";
			state.executeUpdate(sql1);
			String sql2 = "update Book set Publisher='"+getPublisher()+"' where Title='"+getTitle()+"'";
			state.executeUpdate(sql2);
			String sql3 = "update Book set PublishDate='"+getPublishDate()+"' where Title='"+getTitle()+"'";
